...
INSERT INTO [dbo].[Post] ([Id], [Title], [ShortDescription], [Description], [Content], [Published], [PostedOn], [Modified], [Category_Id], [UrlSlug])  VALUES (7, N'Install MySql', N'How to install MySql.', N'How to install and configure MySql for use with Kodi.', N'MySql', 1, N'2015-10-19 00:00:00', N'2015-10-19 00:00:00', 6, N'MySql')
